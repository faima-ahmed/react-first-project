...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 bg-stone-300
      px-6 py-5 ">
      ...
      <ul className="divide-stone-300 divide-y border-b-2 border-stone-300 border-t">
        {cart.map((item)=>(
